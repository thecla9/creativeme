    ...
    <div class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">NipeX Store Request</h1>
...
//if(isset($_POST['search'])){    //trigger button click
 ...
 $query=mysqli_query($conn,"SELECT * FROM `request_approval`");
...
if ( mysqli_num_rows($query) > 0) {
  ...
  <th>Quantity</th>
   ...
   echo"</tr>";
     echo"<td>".$to=$row["to"]."</td>" ;
     echo"<td>".$from=$row["from"]."</td>" ;
      echo"<td>".$date=$row["date"]."</td>" ;
       echo"<td>".$description1=$row["description1"]."</td>" ;
        echo"<td>".$description2=$row["description2"]."</td>" ;
        echo"<td>".$description3=$row["description3"]."</td>" ;
         echo"<td>".$description4=$row["description4"]."</td>" ;
         echo"<td>".$quantity=$row["quantity"]."</td>" ;
          echo "</td>";
echo"</table>";
  }
}else{
    echo "No request found <br><br>";
  }
